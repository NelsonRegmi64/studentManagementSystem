...
<aside class="sidebar" id="sidebar">
  ...
  <nav class="sidebar-nav">
    ...
    <a href="students.php" class="nav-item <?= in_array($current_page, ['students.php','edit-student.php','view-student.php']) ? 'active' : '' ?>">
    ...
    <a href="add-student.php" class="nav-item <?= $current_page == 'add-student.php' ? 'active' : '' ?>">
    ...
    <a href="events.php" class="nav-item <?= in_array($current_page, ['events.php','add-event.php','edit-event.php']) ? 'active' : '' ?>">
    ...
    <a href="attendance.php" class="nav-item <?= $current_page == 'attendance.php' ? 'active' : '' ?>">
      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><rect x="8" y="2" width="8" height="4" rx="1"/><path d="M9 14l2 2 4-4"/></svg>
      Attendance
    </a>
